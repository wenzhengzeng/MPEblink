        ...
        for clip_index in range(0, clip_num):
            ...
            if clip_index!=0:
                ...
                if args.nms:
                    ...
                    det_blinks = det_blinks[sorted_order]
                    ...
                    det_blinks = det_blinks[preserved_list]
            ...
            if args.nms:
                    ...
                    video_det_blinks = video_det_blinks[sorted_order]
                    ...
                    video_det_blinks = video_det_blinks[preserved_list]
